...
B = vpa([h1(1)*h2(1)+h1(2)*h2(2),h1(3)*h2(1)+h1(1)*h2(3),h1(2)*h2(3)+h1(3)*h2(2),h1(3)*h2(3);
    h1(1)*h1(1)+h1(2)*h1(2)-(h2(1)*h2(1)+h2(2)*h2(2)),2*(h1(3)*h1(1)-h2(3)*h2(1)),2*(h1(2)*h1(3)-h2(2)*h2(3)),h1(3)*h1(3)-h2(3)*h2(3);
    h3(1)*h4(1)+h3(2)*h4(2),h3(3)*h4(1)+h3(1)*h4(3),h3(2)*h4(3)+h3(3)*h4(2),h3(3)*h4(3)]);
...
p3 = T*[p3';1];
p4 = T*[p4';1];
A = vpa([p1(1) p1(2) 1 0 0 0 -(p1n(1)*p1(1)) -(p1(2)*p1n(1)) -p1n(1);
